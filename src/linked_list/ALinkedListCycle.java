...
public class ALinkedListCycle {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Has Cycle : " + ALinkedListCycle.doesLoopExist(head) + " with the length : " + ALinkedListCycle.cycleLength(head) + " starting at : " + ALinkedListCycle.startingNode(head).value);
